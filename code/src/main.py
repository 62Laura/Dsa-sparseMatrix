...
def main():
    ...
    try:
        ...
        try:
            ...
            print(f"Could not perform addition: {e}")
        ...
        try:
            ...
            print(f"Could not perform subtraction: {e}")
        ...
        try:
            ...
            print(f" Multiplication saved to: {outputMultPath}")
        except Exception as e:
            print(f"Could not perform multiplication: {e}")
